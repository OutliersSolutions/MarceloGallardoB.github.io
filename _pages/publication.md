...
* Dynamical Systems and Optimal Control for Economists - Under review (Springer Verlag) <br>
 [Jorge Chávez](https://www.pucp.edu.pe/profesor/jorge-chavez-fuentes) and  Marcelo Gallardo . <br>
  <details> 
    <summary>
        Summary |
...
* Fundamentals of Econometric Theory - To appear in [Decon PUCP](https://departamento-economia.pucp.edu.pe/) <br>
Marcelo Gallardo and [Juan Leon Jara-Almonte](https://www.grade.org.pe/en/investigadores/personal/jleon/) . <br>
  <details> 
    <summary>
        Summary |
