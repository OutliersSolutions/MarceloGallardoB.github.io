...
- [Problem set 8]({{ "/files/courses/Financial-microeconomics/Problem_set_8_juegos_bayesianos.pdf" | relative_url }})
- [Problem set 9]({{ "/files/courses/Financial-microeconomics/Problem_set_9_micro_fin.pdf" | relative_url }})

---

### Solutions to Problem Sets
- [Solutions to problem set 1]({{ "/files/courses/Financial-microeconomics/Problem_set_1_Micro_Fin_sol.pdf" | relative_url }})
- [Solutions to problem set 2]({{ "/files/courses/Financial-microeconomics/Problem_set_2_Micro_Financiera_sol.pdf" | relative_url }})
...
- [Solutions to problem set 6]({{ "/files/courses/Financial-microeconomics/Problem_set_6_Micro_Fin.pdf" | relative_url }})
- [Solutions to problem set 8]({{ "/files/courses/Financial-microeconomics/Problem_set_8_sol.pdf" | relative_url }})
- [Solutions to problem set 9]({{ "/files/courses/Financial-microeconomics/Problem_set_9_sol.pdf" | relative_url }})
...
- [Advanced exercises choice under uncertainty]({{ "/files/courses/Financial-microeconomics/ejercicios_incertidumbre_avanzados_lecture_notes.pdf" | relative_url }})
- [Expected utility representation]({{ "/files/courses/Financial-microeconomics/utilidad_esperada_lecture_notes.pdf" | relative_url }})
- [Introduction to game theory]({{ "/files/courses/Financial-microeconomics/juegos_lecture_notes.pdf" | relative_url }})
- [Asymmetric information]({{ "/files/courses/Financial-microeconomics/informacion_asimetrica_lecture_notes.pdf" | relative_url }})
- [Introduction to contract theory]({{ "/files/courses/Financial-microeconomics/teoria_contratos_lecture_notes.pdf" | relative_url }})
